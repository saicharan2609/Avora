...
The `primitives` directory owns mobile primitive contracts for Avora.

Primitives are the mobile layer where accessibility obligations are satisfied before domain components and surfaces consume them.
